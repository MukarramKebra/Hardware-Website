...
const PRODUCTS = [
  ...
  { id:1,  name:'Stainless Steel Shataffa Sprayer',   category:'shataffa',     price:3.500,  img:UL(1),  desc:'Heavy-duty stainless steel bidet hand sprayer with metal valve. Corrosion-resistant, easy to install next to any toilet.', badge:'Best Seller', stock:'in-stock' },
  { id:2,  name:'Wall-Mount Shataffa Set',            category:'shataffa',     price:5.200,  img:UL(2),  desc:'Complete wall-mount bidet sprayer set including holder, 1.2m hose and T-valve. Chrome finish, all fittings included.', badge:null, stock:'in-stock' },
  { id:3,  name:'Dual-Mode Bidet Sprayer',            category:'shataffa',     price:7.800,  img:UL(3),  desc:'Two-mode pressure control sprayer with soft and strong jet settings. Anti-leak brass head, ergonomic grip.', badge:null, stock:'in-stock' },
  { id:4,  name:'Clip-On Bidet Toilet Attachment',   category:'shataffa',     price:4.500,  img:UL(4),  desc:'Easy clip-on bidet attachment fits most standard toilets. Cold water, no electricity needed, installs in minutes.', badge:null, stock:'in-stock' },
  { id:5,  name:'Braided Shataffa Hose 1.2m',        category:'shataffa',     price:1.200,  img:UL(5),  desc:'1.2m stainless steel braided flexible hose for bidet sprayers. 1/2" fittings, burst-proof inner tube.', badge:null, stock:'in-stock' },
  { id:6,  name:'Angle Valve with T-Connector',      category:'shataffa',     price:1.800,  img:UL(6),  desc:'Chrome angle stop valve with T-piece connector for shataffa installation. Quarter-turn operation, 1/2" BSP.', badge:null, stock:'in-stock' },
  { id:7,  name:'Brushed Nickel Bidet Sprayer',      category:'shataffa',     price:8.500,  img:UL(7),  desc:'Premium brushed nickel bidet hand sprayer. Heavy solid brass body, drip-free ceramic valve, luxury finish.', badge:null, stock:'in-stock' },
  { id:8,  name:'Shataffa Holder Hook Chrome',       category:'shataffa',     price:0.800,  img:UL(8),  desc:'Adjustable chrome shataffa sprayer holder. Mounts on wall or cistern. Keeps sprayer accessible and neat.', badge:null, stock:'in-stock' },
  { id:9,  name:'Hot & Cold Bidet Mixer Set',        category:'shataffa',     price:12.000, img:UL(9),  desc:'Hot and cold water bidet sprayer set with thermostatic mixing valve. Delivers warm comfortable water wash.', badge:null, stock:'low-stock' },
  { id:10, name:'Non-Return Check Valve 1/2"',       category:'shataffa',     price:0.600,  img:UL(10), desc:'Brass non-return check valve 1/2" for shataffa and bidet lines. Prevents back-flow contamination.', badge:null, stock:'in-stock' },
  // ── TOILET SEATS (11-18) ──────────────────────────────────────────────────
  { id:11, name:'Standard White Toilet Seat',        category:'toilet-seats', price:4.500,  img:UL(11), desc:'Standard polypropylene toilet seat with chrome hinges. Universal fitting for most toilet bowls, easy to clean.', badge:'Best Seller', stock:'in-stock' },
  { id:12, name:'Soft-Close Toilet Seat',            category:'toilet-seats', price:9.800,  img:UL(12), desc:'Slow soft-close mechanism prevents slamming. PP material, adjustable hinges, quick-release for cleaning.', badge:'Popular', stock:'in-stock' },
  { id:13, name:'Slim Soft-Close Toilet Seat',       category:'toilet-seats', price:11.500, img:UL(13), desc:'Ultra-slim profile soft-close toilet seat. Scratch-resistant surface, top-fix installation, white gloss finish.', badge:null, stock:'in-stock' },
  { id:14, name:'D-Shape Soft-Close Seat',           category:'toilet-seats', price:10.200, img:UL(14), desc:'D-shaped soft-close seat for modern back-to-wall and wall-hung toilets. Chrome hinges, white PP.', badge:null, stock:'in-stock' },
  { id:15, name:'Kids Toilet Training Seat',         category:'toilet-seats', price:3.200,  img:UL(15), desc:'Soft padded training seat insert for young children. Non-slip base, fits standard round and oval bowls.', badge:null, stock:'in-stock' },
  { id:16, name:'Quick-Release Toilet Seat',         category:'toilet-seats', price:8.500,  img:UL(16), desc:'One-click quick-release hinges allow full removal for deep cleaning. Includes soft-close mechanism.', badge:null, stock:'in-stock' },
  { id:17, name:'Elongated Toilet Seat White',       category:'toilet-seats', price:6.800,  img:UL(17), desc:'Elongated oval toilet seat with standard close hinges. White heavy-duty PP, durable chrome fixings.', badge:null, stock:'in-stock' },
  { id:18, name:'Antibacterial Soft-Close Seat',     category:'toilet-seats', price:14.500, img:UL(18), desc:'Antibacterial treated toilet seat with soft-close and quick-release hinges. Inhibits bacterial growth.', badge:null, stock:'low-stock' },
  // ── LIGHTING (19-28) ──────────────────────────────────────────────────────
  { id:19, name:'LED Bulb E27 9W Warm White',        category:'lighting',     price:0.600,  img:UL(19), desc:'9W E27 LED bulb, 810 lumens, 3000K warm white. Replaces 60W incandescent. 15,000-hour lifespan.', badge:'Best Seller', stock:'in-stock' },
  { id:20, name:'LED Bulb E27 12W Daylight',         category:'lighting',     price:0.750,  img:UL(20), desc:'12W E27 LED bulb, 1080 lumens, 6500K daylight. Instant full brightness, 80% energy saving.', badge:null, stock:'in-stock' },
  { id:21, name:'LED Bulb E14 6W Warm White',        category:'lighting',     price:0.550,  img:UL(21), desc:'6W E14 small Edison screw LED. 550 lumens, 3000K warm white. For chandeliers and decorative lamps.', badge:null, stock:'in-stock' },
  { id:22, name:'LED Spotlight GU10 7W',             category:'lighting',     price:0.900,  img:UL(22), desc:'7W GU10 LED spotlight, 630 lumens, 4000K neutral white. 38-degree beam, ideal for kitchens and bathrooms.', badge:null, stock:'in-stock' },
  { id:23, name:'LED Recessed Downlight 12W',        category:'lighting',     price:2.500,  img:UL(23), desc:'12W recessed LED downlight, 90mm cut-out, 3000K warm white. Ultra-slim design, tool-free spring clips.', badge:null, stock:'in-stock' },
  { id:24, name:'LED Strip Light 5m 12V',            category:'lighting',     price:3.800,  img:UL(24), desc:'5-metre 12V LED strip, 300 LEDs, warm white, self-adhesive backing. Cuttable every 50mm.', badge:'Popular', stock:'in-stock' },
  { id:25, name:'LED Panel Light 18W 30x30cm',       category:'lighting',     price:4.500,  img:UL(25), desc:'18W 300x300mm slim LED panel, 1600 lumens, 6500K daylight. For false ceilings and offices.', badge:null, stock:'in-stock' },
  ...
  // ── TAPS & MIXERS (29-38) ─────────────────────────────────────────────────
  { id:29, name:'Basin Mixer Tap Chrome',            category:'taps',         price:9.800,  img:UL(29), desc:'Single lever basin mixer, chrome finish, solid brass body. 35mm ceramic cartridge, 1/2" hot and cold inlets.', badge:'Best Seller', stock:'in-stock' },
  ...
  { id:41, name:'Braided Flexible Hose 40cm',        category:'plumbing',     price:0.800,  img:UL(41), desc:'40cm stainless steel braided connector 3/8" x 1/2". Anti-burst, for basin and toilet supply.', badge:'Best Seller', stock:'in-stock' },
  ...
  { id:50, name:'Toilet Roll Holder Chrome',         category:'bathroom',     price:2.800,  img:UL(50), desc:'Wall-mount chrome toilet roll holder. Solid brass with spring-loaded paper bar. Concealed screw fixing.', badge:'Popular', stock:'in-stock' },
  ...
  { id:59, name:'Close-Coupled Toilet Suite',        category:'sanitaryware', price:65.000, img:UL(59), desc:'Complete close-coupled toilet with soft-close seat, dual flush 4/6L cistern. White vitreous china.', badge:'Popular', stock:'in-stock' },
