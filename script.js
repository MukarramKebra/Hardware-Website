...
const PRODUCTS = [
  ...
  { id:27, name:'Smart RGB LED Bulb E27 10W',        category:'lighting',     price:3.200,  img:'Rawaj Products/SKU-0027.jpg', desc:'WiFi smart LED bulb with 16 million colours and warm white. Works with Alexa and Google Home.', badge:null, stock:'in-stock' },
  ...
  { id:30, name:'Kitchen Sink Mixer Tap',            category:'taps',         price:11.500, img:'Rawaj Products/SKU-0030.jpg', desc:'Single lever kitchen mixer with 360° swivel spout. Chrome brass, ceramic disc, easy install flexible tails.', badge:null, stock:'in-stock' },
  { id:31, name:'Pull-Out Kitchen Spray Tap',        category:'taps',         price:18.500, img:'Rawaj Products/SKU-0031.jpg', desc:'Pull-out spray head kitchen mixer tap. 2-function spray and stream modes. Braided hose, chrome finish.', badge:null, stock:'in-stock' },
  { id:32, name:'Bath & Shower Mixer Valve',         category:'taps',         price:16.000, img:'Rawaj Products/SKU-0032.jpg', desc:'Exposed bath and shower mixer valve with diverter. Chrome solid brass, 1/2" inlets, anti-scald ceramic.', badge:null, stock:'in-stock' },
  { id:33, name:'Pillar Tap Pair Hot & Cold',        category:'taps',         price:5.500,  img:'Rawaj Products/SKU-0033.jpg', desc:'Pair of chrome pillar taps hot and cold. Quarter-turn ceramic disc, 1/2" BSP. For baths and basins.', badge:null, stock:'in-stock' },
  { id:34, name:'Wall-Mount Basin Mixer Tap',        category:'taps',         price:14.000, img:'Rawaj Products/SKU-0034.jpg', desc:'Wall-mounted basin mixer tap, 150mm centre distance. Chrome long spout, ceramic cartridge, flexible tails.', badge:null, stock:'in-stock' },
  { id:35, name:'Thermostatic Shower Bar Set',       category:'taps',         price:28.000, img:'Rawaj Products/SKU-0035.jpg', desc:'Exposed thermostatic shower bar with overhead rain head and handheld shower. Chrome brass, anti-scald.', badge:null, stock:'low-stock' },
  { id:36, name:'Tap Aerator M22 Flow Saver',        category:'taps',         price:0.400,  img:'Rawaj Products/SKU-0036.jpg', desc:'M22 chrome tap aerator with water-saving flow restrictor. Reduces tap flow to 5 litres per minute.', badge:null, stock:'in-stock' },
  { id:37, name:'Quarter-Turn Stop Cock 1/2"',       category:'taps',         price:1.200,  img:'Rawaj Products/SKU-0037.jpg', desc:'Brass quarter-turn full-bore stop cock 1/2" BSP. For water supply isolation under basins and WCs.', badge:null, stock:'in-stock' },
  { id:38, name:'Tall Single Lever Basin Mixer',     category:'taps',         price:13.500, img:'Rawaj Products/SKU-0038.jpg', desc:'Tall single lever basin mixer for countertop vessel basins. Chrome, 450mm height, ceramic cartridge.', badge:null, stock:'in-stock' },
  // ── PLUMBING (39-48) ──────────────────────────────────────────────────────
  { id:39, name:'PVC Pressure Pipe 1/2" x 3m',      category:'plumbing',     price:1.200,  img:'Rawaj Products/SKU-0039.jpg', desc:'White PVC pressure pipe 1/2" (15mm) x 3 metres. For cold water supply lines and irrigation systems.', badge:null, stock:'in-stock' },
  { id:40, name:'CPVC Hot Water Pipe 3/4" x 3m',    category:'plumbing',     price:2.200,  img:'Rawaj Products/SKU-0040.jpg', desc:'CPVC pipe 3/4" x 3m rated to 93°C. For hot and cold water supply. Solvent weld fittings.', badge:null, stock:'in-stock' },
  ...
  { id:42, name:'Braided Flexible Hose 60cm',        category:'plumbing',     price:1.000,  img:'Rawaj Products/SKU-0042.jpg', desc:'60cm braided flexible connector 3/8" x 1/2". Anti-burst stainless braid with EPDM inner tube.', badge:null, stock:'in-stock' },
  { id:43, name:'PTFE Teflon Tape 12m',              category:'plumbing',     price:0.200,  img:'Rawaj Products/SKU-0043.jpg', desc:'12m PTFE thread seal tape, 12mm wide, white. Essential for sealing all threaded pipe joints.', badge:null, stock:'in-stock' },
  { id:44, name:'PVC Elbow 90° 1/2" — 10 Pack',     category:'plumbing',     price:0.500,  img:'Rawaj Products/SKU-0044.jpg', desc:'Pack of 10 PVC 90° elbows 1/2". Solvent weld for cold water pipework. Pressure rated.', badge:null, stock:'in-stock' },
  { id:45, name:'Brass Ball Valve 1/2"',             category:'plumbing',     price:1.500,  img:'Rawaj Products/SKU-0045.jpg', desc:'Full-bore brass ball valve 1/2" with lever handle. Chrome plated, rated for water and gas lines.', badge:null, stock:'in-stock' },
  { id:46, name:'P-Trap Waste Bend 32mm',            category:'plumbing',     price:1.200,  img:'Rawaj Products/SKU-0046.jpg', desc:'32mm white P-trap with adjustable telescopic pipe. For hand basins and vanity units. Easy-fit push seal.', badge:null, stock:'in-stock' },
  { id:47, name:'Sanitary Silicone Sealant 280ml',   category:'plumbing',     price:1.200,  img:'Rawaj Products/SKU-0047.jpg', desc:'Mould-resistant white sanitary silicone 280ml. For sealing baths, basins, shower trays and tiles.', badge:null, stock:'in-stock' },
  { id:48, name:'Drain Auger Cleaning Snake 5m',     category:'plumbing',     price:3.500,  img:'Rawaj Products/SKU-0048.jpg', desc:'5m flexible drain auger with T-handle. Clears blocked sinks, basins, showers and floor drains.', badge:null, stock:'in-stock' },
  // ── BATHROOM ACCESSORIES (49-56) ──────────────────────────────────────────
  { id:49, name:'Round Towel Ring Chrome',           category:'bathroom',     price:3.200,  img:'Rawaj Products/SKU-0049.jpg', desc:'Round wall-mounted chrome towel ring. Solid brass construction with concealed fixings. Easy to install.', badge:null, stock:'in-stock' },
  ...
  { id:51, name:'Double Towel Bar 60cm Chrome',      category:'bathroom',     price:5.500,  img:'Rawaj Products/SKU-0051.jpg', desc:'600mm double towel rail bar in chrome. Solid brass body, wall-mounted with concealed screws.', badge:null, stock:'in-stock' },
  { id:52, name:'Wall-Mount Soap Dispenser',         category:'bathroom',     price:4.200,  img:'Rawaj Products/SKU-0052.jpg', desc:'300ml wall-mounted soap dispenser with chrome pump and ceramic body. Refillable, drip-free nozzle.', badge:null, stock:'in-stock' },
  { id:53, name:'Frameless Bathroom Mirror 60x80',   category:'bathroom',     price:12.000, img:'Rawaj Products/SKU-0053.jpg', desc:'60x80cm frameless bevelled edge bathroom mirror. Wall-mounted, suitable horizontal or vertical.', badge:null, stock:'in-stock' },
  { id:54, name:'Shower Curtain + 12 Rings 180x200', category:'bathroom',     price:4.500,  img:'Rawaj Products/SKU-0054.jpg', desc:'180x200cm waterproof polyester shower curtain with 12 chrome rings. Machine washable.', badge:null, stock:'in-stock' },
  { id:55, name:'Chrome Corner Shower Shelf',        category:'bathroom',     price:6.800,  img:'Rawaj Products/SKU-0055.jpg', desc:'Stainless steel corner shower caddy shelf, chrome finish. No-drill adhesive fixing, rust-proof.', badge:null, stock:'in-stock' },
  { id:56, name:'Double Robe Hook Chrome',           category:'bathroom',     price:2.200,  img:'Rawaj Products/SKU-0056.jpg', desc:'Double chrome robe and towel hook. Wall-mounted solid brass with concealed fixing plate.', badge:null, stock:'in-stock' },
  // ── SANITARYWARE (57-60) ──────────────────────────────────────────────────
  { id:57, name:'Wall-Hung Basin 50cm White',        category:'sanitaryware', price:35.000, img:'Rawaj Products/SKU-0057.jpg', desc:'50cm wall-hung vitreous china wash basin, white. Includes fixing bolts. Single tap hole with overflow.', badge:null, stock:'in-stock' },
  { id:58, name:'Pedestal Basin 55cm White',         category:'sanitaryware', price:28.000, img:'Rawaj Products/SKU-0058.jpg', desc:'55cm pedestal wash basin, white vitreous china. Full pedestal included, single tap hole, overflow.', badge:null, stock:'in-stock' },
  ...
  { id:60, name:'Concealed Cistern Frame',           category:'sanitaryware', price:45.000, img:'Rawaj Products/SKU-0060.jpg', desc:'Steel in-wall concealed cistern frame for wall-hung toilets. Height-adjustable 820–1000mm, dual flush.', badge:null, stock:'low-stock' }
];
