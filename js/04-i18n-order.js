...
var _T = {
  en: {
    ...
    footer_returns:'Returns Policy', footer_tech:'Technical Help', footer_accessibility:'Accessibility',
  ...
  ar: {
    ...
    footer_returns:'سياسة الإرجاع', footer_tech:'المساعدة التقنية', footer_accessibility:'إمكانية الوصول',
